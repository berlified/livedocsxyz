    ...
    <div className="overflow-hidden rounded-xl border border-border">
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border bg-card px-3 py-2">
        ...
        <div className="flex items-center gap-2">
          <select aria-label="Preview reaction state" value={state} onChange={(event) => setState(event.target.value as ChartEmotion | "data")} className="h-7 rounded-full border border-input bg-background px-2 text-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
